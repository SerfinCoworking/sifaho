...
RSpec.describe "inpatient_prescription_products/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit inpatient_prescription_product form" do
    render

    assert_select "form[action=?][method=?]", inpatient_prescription_product_path(@inpatient_prescription_product), "post" do
