$(document).on('turbolinks:load', function(e){
  if(!(_PAGE.controller === 'establishments/external_orders/applicants' && (['new', 'edit', 'new_provider', 'edit_provider', 'accept_provider', 'create_applicant', 'update_applicant', 'create_provider', 'update_provider'].includes(_PAGE.action))) ) return false;
