class ExternalOrdersController < ApplicationController
  before_action :set_external_order, only: [:show, :send_provider, :send_applicant, :destroy, :delete, :return_applicant_status, :edit_provider, :edit_applicant,
    :update_applicant, :receive_applicant_confirm, :receive_applicant, :receive_order, :receive_order_confirm, :nullify, :nullify_confirm ]
  ...
  private
    ...
    def external_order_params
      ...
      external_order_products_attributes: [
        ...
        :_destroy,
        ext_ord_prod_lot_stocks_attributes: [
          :id,
          :quantity,
          :lot_stock_id,
          :_destroy
