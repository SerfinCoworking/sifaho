...
ActiveRecord::Schema.define(version: 20171201004203) do
  ...
  create_table "patients", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "patient_types_id"
    t.bigint "patient_type_id"
    t.index ["patient_type_id"], name: "index_patients_on_patient_type_id"
    t.index ["patient_types_id"], name: "index_patients_on_patient_types_id"
  end
  ...
  add_foreign_key "patients", "patient_types", column: "patient_types_id"
end
