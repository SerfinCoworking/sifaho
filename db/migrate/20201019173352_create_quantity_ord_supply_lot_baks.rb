class CreateQuantityOrdSupplyLotBaks < ActiveRecord::Migration[5.2]
  def change
    create_table :quantity_ord_supply_lot_baks do |t|
      t.string :lot_code
      t.references :quantifiable, polymorphic: true, index: { name: 'quant_ord_sup_lot_polym' }
