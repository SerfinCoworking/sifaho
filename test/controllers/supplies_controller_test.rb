...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { date_received: @supply.date_received, expiry_date: @supply.expiry_date, quantity: @supply.quantity } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { date_received: @supply.date_received, expiry_date: @supply.expiry_date, quantity: @supply.quantity } }
